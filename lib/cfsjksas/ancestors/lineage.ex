defmodule Cfsjksas.Ancestors.Lineage do
  ...
  def a_id_from_relation(relation) do
    # get all keys
    a_ids = Cfsjksas.Ancestors.AgentStores.all_a_ids
  ...
  def a_id_from_relation(relation, [a_id | rest_a_ids]) do
    ancestor = Cfsjksas.Ancestors.AgentStores.get_person_a(a_id)
  ...
  def mother(relation) do
    ...
    person = Cfsjksas.Ancestors.AgentStores.get_person_a(relation_a_id)
