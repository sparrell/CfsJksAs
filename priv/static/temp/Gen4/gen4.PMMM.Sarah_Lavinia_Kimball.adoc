...
== Family
* Mother: Mom ID = p0672is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0661is duplicate. Software not written yet to handle, so look up manually
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen4/gen4.PMMM.Sarah_Lavinia_Kimball[Book page]
