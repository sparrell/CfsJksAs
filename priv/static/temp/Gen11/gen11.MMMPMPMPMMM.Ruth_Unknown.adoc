...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen11/gen11.MMMPMPMPMMM.Ruth_Unknown[Book page]
* https://cfsjksas.gigalixirapp.com/person?p=p1263[Dev website]
* WeRelate TBD
* MyHeritage TBD
* Geni TBD
* WikiTree TBD
