...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/V2_C5_G11/gen11.PMPPPMPPMMP.John_Arnold.adoc[John Arnold (? - 1664)] i.e. this page
* https://cfsjksas.gigalixirapp.com/person?p=p0313[Dev website]
* WeRelate TBD
* MyHeritage TBD
* Geni TBD
* WikiTree TBD
...
* gen11.PMPPPMPPMMP.John_Arnold_(?_-_1664)
