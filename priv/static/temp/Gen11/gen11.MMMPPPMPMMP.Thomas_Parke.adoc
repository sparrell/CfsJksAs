...
== Family
* Mother: Mom ID = p0357is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0356is duplicate. Software not written yet to handle, so look up manually
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen11/gen11.MMMPPPMPMMP.Thomas_Parke[Book page]
