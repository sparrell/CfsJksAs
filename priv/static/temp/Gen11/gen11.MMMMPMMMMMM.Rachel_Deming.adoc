...
== Family
* Mother: Mom ID = p0481is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0480is duplicate. Software not written yet to handle, so look up manually
* Child*: https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen10/gen10.MMMMPMMMMM.Sarah_Morgan[Sarah Morgan (1678 - ?)]



== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen11/gen11.MMMMPMMMMMM.Rachel_Deming[Book page]
