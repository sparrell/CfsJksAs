...
== Family
* Mother: Mom ID = p0425is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0962is duplicate. Software not written yet to handle, so look up manually
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen11/gen11.MMMMPPMPMMP.Samuel_Chesebrough[Book page]
