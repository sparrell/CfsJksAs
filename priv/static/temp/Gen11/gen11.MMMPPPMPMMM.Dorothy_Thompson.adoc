...
== Family
* Mother: Mom ID = p1023is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0358is duplicate. Software not written yet to handle, so look up manually
* Child*: https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen10/gen10.MMMPPPMPMM.Martha_Parke[Martha Parke (1646 - 1716)]



== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen11/gen11.MMMPPPMPMMM.Dorothy_Thompson[Book page]
