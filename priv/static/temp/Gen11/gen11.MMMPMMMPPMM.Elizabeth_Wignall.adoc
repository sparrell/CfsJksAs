...
* Sex: F
* Birth: 1604
* Birthplace: Frating, Essex, England, UK
* Death: 16 SEP 1668
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen11/gen11.MMMPMMMPPMM.Elizabeth_Wignall[Book page]
* https://cfsjksas.gigalixirapp.com/person?p=p0564[Dev website]
* WeRelate TBD
* MyHeritage TBD
* Geni TBD
* WikiTree TBD
