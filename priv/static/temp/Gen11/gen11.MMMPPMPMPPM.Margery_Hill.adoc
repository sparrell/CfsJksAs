...
== Family
* Mother: Mom ID = p0303is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0302is duplicate. Software not written yet to handle, so look up manually
* Child*: https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen10/gen10.MMMPPMPMPP.John_Morgan[John Morgan (1645 - 1712)]



== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen11/gen11.MMMPPMPMPPM.Margery_Hill[Book page]
