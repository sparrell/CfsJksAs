...
== Family
* Mother: not clear what happening
* Father: not clear what happening
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen12/gen12.MMMMPPPMPPMP.John_Thompson[Book page]
