...
* Death: 12 APR 1683
* Deathplace: Woburn, Middlesex, Massachusetts, USA
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen12/gen12.MMMPPMMMPMMP.Henry_Brooks[Book page]
* https://cfsjksas.gigalixirapp.com/person?p=p0920[Dev website]
* WeRelate TBD
* MyHeritage TBD
* Geni TBD
* WikiTree TBD
