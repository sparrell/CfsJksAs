...
== Family
* Mother: Mom ID = p0951is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0422is duplicate. Software not written yet to handle, so look up manually
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen9/gen9.MMMPMPPPP.Elisha_Chesebrough[Book page]
