...
== Family
* Mother: Mom ID = p0339is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0340is duplicate. Software not written yet to handle, so look up manually
* Child*: https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen8/gen8.MMMMMPPP.Jonathan_Lester[Jonathan Lester (1702 - 1774)]



== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen9/gen9.MMMMMPPPP.Jonathan_Lester[Book page]
