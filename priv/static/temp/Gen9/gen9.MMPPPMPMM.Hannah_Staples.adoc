...
* Father: https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen10/gen10.MMPPPMPMMP.Thomas_Staples[Thomas Staples (1620 - 1688)]
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen9/gen9.MMPPPMPMM.Hannah_Staples[Book page]
* https://cfsjksas.gigalixirapp.com/person?p=p0774[Dev website]
* WeRelate TBD
* MyHeritage TBD
* Geni TBD
