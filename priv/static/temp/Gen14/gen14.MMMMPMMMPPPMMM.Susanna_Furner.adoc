...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen14/gen14.MMMMPMMMPPPMMM.Susanna_Furner[Book page]
* https://cfsjksas.gigalixirapp.com/person?p=p0850[Dev website]
* WeRelate TBD
* MyHeritage TBD
* Geni TBD
* WikiTree TBD
