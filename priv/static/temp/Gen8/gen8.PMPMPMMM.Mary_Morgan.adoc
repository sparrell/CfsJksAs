...
== Family
* Mother: Mom ID = p0397is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0400is duplicate. Software not written yet to handle, so look up manually
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen8/gen8.PMPMPMMM.Mary_Morgan[Book page]
