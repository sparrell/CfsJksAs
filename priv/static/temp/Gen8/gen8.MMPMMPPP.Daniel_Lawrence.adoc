...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/V2_C5_G8/gen8.MMPMMPPP.Daniel_Lawrence.adoc[Daniel Lawrence (? - ?)] i.e. this page
...
* gen8.MMPMMPPP.Daniel_Lawrence_(?_-_?)
