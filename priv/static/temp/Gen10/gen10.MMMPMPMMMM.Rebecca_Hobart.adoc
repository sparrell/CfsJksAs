...
== Family
* Mother: Mom ID = p0836is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0818is duplicate. Software not written yet to handle, so look up manually
* Child*: https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen9/gen9.MMMPMPMMM.Rebecca_Mason[Rebecca Mason (1682 - 1742)]



== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen10/gen10.MMMPMPMMMM.Rebecca_Hobart[Book page]
