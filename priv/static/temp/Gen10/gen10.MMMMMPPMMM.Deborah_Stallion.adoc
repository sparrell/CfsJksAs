...
== Family
* Mother: Mom ID = p0270is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0269is duplicate. Software not written yet to handle, so look up manually
* Child*: https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen9/gen9.MMMMMPPMM.Deborah_Avery[Deborah Avery (1670 - 1739)]



== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen10/gen10.MMMMMPPMMM.Deborah_Stallion[Book page]
