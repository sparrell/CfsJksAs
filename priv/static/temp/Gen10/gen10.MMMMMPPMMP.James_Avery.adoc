...
== Family
* Mother: Mom ID = p0267is duplicate. Software not written yet to handle, so look up manually
* Father: Dad ID = p0266is duplicate. Software not written yet to handle, so look up manually
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/gen10/gen10.MMMMMPPMMP.James_Avery[Book page]
