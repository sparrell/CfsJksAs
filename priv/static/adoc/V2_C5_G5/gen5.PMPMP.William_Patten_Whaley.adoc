...
https://cfsjksas.gigalixirapp.com/person?p=p0050http://localhost:4000/person?p=p0050https://cfsjksas.gigalixirapp.com/adoc?p=p0050http://localhost:4000/adoc?p=p0050* Geni TBD
* MyHeritage TBD
...
* gen5.PMPMP.William_Patten_Whaley_(1786 - ?)
