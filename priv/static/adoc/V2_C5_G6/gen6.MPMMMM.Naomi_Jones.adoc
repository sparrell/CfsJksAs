...
== Family
* Mother: brickwall
* Father: https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/V2_C5_G7/gen7.MPMMMMP.Thomas_Jones.adoc[Thomas Jones (? - ?)]
...
== Reference Links
* https://github.com/sparrell/cfs_ancestors/blob/main/Vol_02_Ships/V2_C5_Ancestors/V2_C5_G6/gen6.MPMMMM.Naomi_Jones.adoc[Book Link]
* https://cfsjksas.gigalixirapp.com/person?p=p0500[Dev-web]
* https://localhost:4000/person?p=p0500[Dev-local]
* https://cfsjksas.gigalixirapp.com/adoc?p=p0500[Adoc-web]
* https://localhost:4000/adoc?p=p0500[Adoc-local]
* Geni TBD
* MyHeritage TBD
...
* gen6.MPMMMM.Naomi_Jones_(?_-_1778)
